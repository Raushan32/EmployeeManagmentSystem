 ...
 * @author rkhjp
 */
public class SumSalByJob extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SumSalByJob</title>");            
            out.println("</head>");
            ...
            out.println("<tr>");
            out.println("<th> Sum Salary By JOB </th>");
            out.println("</tr>");
            String job=request.getParameter("job");
            EmpDAO ed=new EmpDAO();
            double sum;
            sum = ed.sumSalByJob(job);
            out.println("<tr>");
            out.println("<th>"+sum+"</th>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</center>");
//            out.println("<h1>Servlet SumSalByJob at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SumSalByJob.class.getName()).log(Level.SEVERE, null, ex);
