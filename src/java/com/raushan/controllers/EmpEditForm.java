 ...
 * @author rkhjp
 */
public class EmpEditForm extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EmpEditForm</title>");            
            out.println("</head>");
            ...
            out.println("<body>");
            out.println("<h1>Servlet EmpEditForm at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
