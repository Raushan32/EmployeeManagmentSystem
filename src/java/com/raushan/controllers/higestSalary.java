...
public class higestSalary extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet higestSalary</title>");            
            out.println("</head>");
            ...
            out.println("<table border='2px' width='20%'>");
               out.println("<tr>");
              out.println("<th>Higest Salary </th>");  
              out.println("</tr>");
              EmpDAO ed =new EmpDAO();
            ArrayList<EmpBean> al=ed.higestSal();
           int max=0;
            for(EmpBean eb :al){
           ...
           out.println("</tr>");
            ...
            out.println("</table>");
            out.println("</center");
//            out.println("<h1>Servlet higestSalary at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(higestSalary.class.getName()).log(Level.SEVERE, null, ex);
