 ...
 * @author rkhjp
 */
public class SumSal extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SumSal</title>");            
            out.println("</head>");
            ...
            out.println("<tr>");
            out.println("<th> Sum Salary </th>");
            out.println("</tr>");
            EmpDAO ed =new EmpDAO();
            double sal=ed.sumSal();
            out.println("<tr>");
...
//            out.println("<h1>Servlet SumSal at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SumSal.class.getName()).log(Level.SEVERE, null, ex);
