 ...
 * @author rkhjp
 */
public class countEmpJob extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet countEmpJob</title>");            
            out.println("</head>");
           ...
           out.println("<body>");
             ...
             out.println("<center>");
            out.println("<table border='1' width='25%'>");
               out.println("<tr>");
            ...
            ArrayList<EmpBean> al=ed.countEmployeeByJob(job);

            
            int length=al.size();
            for(EmpBean eb :al){
            
                // this loop is used only for count the number of employees
            }
            out.println("<tr>");
...
//              out.println("<h1>Servlet countEmp at " + request.getContextPath() + "</h1>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(countEmpJob.class.getName()).log(Level.SEVERE, null, ex);
