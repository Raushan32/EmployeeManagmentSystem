 ...
 * @author rkhjp
 */
public class lowestFiveEmp extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lowestFiveEmp</title>");            
            out.println("</head>");
   ...
   ArrayList< EmpBean >al = ed.topFiveLowestSalEmp();
    out.println("<center>");
    ...
    out.println("</table>");
    out.println("</center");
//            out.println("<h1>Servlet lowestFiveEmp at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(lowestFiveEmp.class.getName()).log(Level.SEVERE, null, ex);
