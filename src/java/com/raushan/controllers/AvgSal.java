 ...
 * @author rkhjp
 */
public class AvgSal extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AvgSal</title>");            
            out.println("</head>");
            ...
            double sal=ed.avgSal("job");
            out.println("<tr>");
            out.println("<th>"+sal+"</th>");
            out.println("</table>");
            out.println("</center>");
//            out.println("<h1>Servlet AvgSal at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AvgSal.class.getName()).log(Level.SEVERE, null, ex);
