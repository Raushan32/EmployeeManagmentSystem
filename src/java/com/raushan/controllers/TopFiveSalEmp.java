 ...
 * @author rkhjp
 */
public class TopFiveSalEmp extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TopFiveSalEmp</title>");            
            out.println("</head>");
   ...
   ArrayList< EmpBean >al = ed.topFiveHigestsal();
    out.println("<center>");
    ...
    out.println("</table>");
    out.println("</center");
//            out.println("<h1>Servlet TopFiveSalEmp at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(TopFiveSalEmp.class.getName()).log(Level.SEVERE, null, ex);
