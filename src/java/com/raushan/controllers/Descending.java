 ...
 * @author rkhjp
 */
public class Descending extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Descending</title>");            
            out.println("</head>");
            ...
            ArrayList<EmpBean> al=ed.sortEmpDesOrder();
            for(EmpBean eb :al){
                out.println("<tr>");
           ...
           out.println("</table>");
            out.println("</center");
//            out.println("<h1>Servlet Descending at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Descending.class.getName()).log(Level.SEVERE, null, ex);
