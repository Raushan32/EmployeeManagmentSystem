 ...
 * @author rkhjp
 */
public class FindAllDeptno extends HttpServlet {
...
out.println("<h1 align='center'>Welcome : "+u+"</h1>");
        ...
        dispatcher.include(request, response);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FindAllDeptno</title>");            
            out.println("</head>");
...
//            out.println("<h1>Servlet FindAllDeptno at " + request.getContextPath() + "</h1>");
            out.println("</table>");
            out.println("</center>");
            out.println("</body>");
            out.println("</html>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FindAllDeptno.class.getName()).log(Level.SEVERE, null, ex);
